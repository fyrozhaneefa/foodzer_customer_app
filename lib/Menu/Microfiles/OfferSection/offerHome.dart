...
import 'package:foodzer_customer_app/Menu/Microfiles/PaymentSection/appbarwidget.dart';
        ...
        body: ListView(
          children: [
            Padding(
              ...
              child: Text("Featured Offers", style: TextStyle(fontWeight: FontWeight.bold,fontSize: 18),),
            ),
            ...
            Padding(padding: EdgeInsets.only(top: 20),child: ApplyButton(buttonname:"VIEW ALL",radius: 7),)
