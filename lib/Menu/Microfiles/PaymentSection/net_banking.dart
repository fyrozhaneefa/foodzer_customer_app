 ...
 class _NetBankingState extends State<NetBanking> {
  ...
  void initState() {
                 ...
                 Container(
                   ...
                   child: Padding(
                     ...
                     child: ListView.separated(
                         ...
                         shrinkWrap: true,
                         itemCount: popularBanksList.length,
                         itemBuilder: (BuildContext context, int index) {
                           return ListTile(
                             onTap: (){
                               setState(() {
                                 _selectedBank = popularBanksList[index]['code'];
                               });
                               orderCheckout();
                             },
                             title: Padding(
                 ...
                 Container(
                   ...
                   child: Padding(
                     ...
                     child: ListView.separated(
                         ...
                         physics: ScrollPhysics(),
                         shrinkWrap: true,
                         itemCount: allBankList.length,
                         itemBuilder: (BuildContext context, int index) {
                           return ListTile(
                             onTap: (){
                               setState(() {
                                 _selectedBank = allBankList[index]['code'];
                               });
                               orderCheckout();
                             },
                             title: Padding(
   ...
   getBankList() async {
     ...
     var response =
     await http.post(Uri.parse(ApiData.GET_NETBANKING_LIST));
     ...
     List popularBank = json['popular_bank_list'];
     List allBank = json['All_bank_list'];
     if(response.statusCode == 200){
       popularBanksList = popularBank;
       allBankList = allBank;
       setState(() {
